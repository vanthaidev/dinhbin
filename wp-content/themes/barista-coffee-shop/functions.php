...
function barista_coffee_shop_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'barista-coffee-shop' ),
		'id'            => 'barista-coffee-shop-footer1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'barista-coffee-shop' ),
		'id'            => 'barista-coffee-shop-footer2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="footer-column-widget-title">',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'barista-coffee-shop' ),
		'id'            => 'barista-coffee-shop-footer3',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="footer-column-widget-title">',
 ...
 * Enqueue Preloader.
 */
function barista_coffee_shop_preloader() {

  $barista_coffee_shop_theme_color_css = '';
  $barista_coffee_shop_preloader_bg_color = get_theme_mod('barista_coffee_shop_preloader_bg_color');
  $barista_coffee_shop_preloader_dot_1_color = get_theme_mod('barista_coffee_shop_preloader_dot_1_color');
  $barista_coffee_shop_preloader_dot_2_color = get_theme_mod('barista_coffee_shop_preloader_dot_2_color');
 
	if(get_theme_mod('barista_coffee_shop_preloader_bg_color') == '') {
		$barista_coffee_shop_preloader_bg_color = '#fff';
	}
	if(get_theme_mod('barista_coffee_shop_preloader_dot_1_color') == '') {
		$barista_coffee_shop_preloader_dot_1_color = '#c1753d';
	}
	if(get_theme_mod('barista_coffee_shop_preloader_dot_2_color') == '') {
		$barista_coffee_shop_preloader_dot_2_color = '#c1753d';
	}
	$barista_coffee_shop_theme_color_css = '
		 
		.loading{
			background-color: '.esc_attr($barista_coffee_shop_preloader_bg_color).';
		 }
		 @keyframes loading {
		  0%,
		  100% {
		  	transform: translatey(-2.5rem);
		    background-color: '.esc_attr($barista_coffee_shop_preloader_dot_1_color).';
		  }
		  50% {
		  	transform: translatey(2.5rem);
		    background-color: '.esc_attr($barista_coffee_shop_preloader_dot_2_color).';
		  }
		}
	';
    wp_add_inline_style( 'barista-coffee-shop-style',$barista_coffee_shop_theme_color_css );

}
add_action( 'wp_enqueue_scripts', 'barista_coffee_shop_preloader' );
