...
<footer id="colophon" class="site-footer border-top">
    <div class="container">
    	<div class="footer-column">
	    	<div class="row">
				<?php if(is_active_sidebar( 'barista-coffee-shop-footer1' ) || is_active_sidebar( 'barista-coffee-shop-footer2' ) || is_active_sidebar( 'barista-coffee-shop-footer3' ) ): ?>
					<div class="col-lg-4 col-md-4">
						<?php if(is_active_sidebar( 'barista-coffee-shop-footer1' )):
							dynamic_sidebar( 'barista-coffee-shop-footer1' );
						endif;
						?>
					</div>

					<div class="col-lg-4 col-md-4">
						<?php if(is_active_sidebar( 'barista-coffee-shop-footer2' )):
							dynamic_sidebar( 'barista-coffee-shop-footer2' );
						endif;
						?>
					</div>

					<div class="col-lg-4 col-md-4">
						<?php if(is_active_sidebar( 'barista-coffee-shop-footer3' )):
							dynamic_sidebar( 'barista-coffee-shop-footer3' );
						endif;
						?>
					</div>
